...
Route::middleware(ProxyApiToNewHosting::class)->group(function () {
    Route::get('/prices', [PriceController::class, 'index'])->middleware('throttle:api-read');
    ...
    Route::middleware('throttle:api-read')->group(function () {
        ...
        Route::get('/buy-requests/options', [BuyRequestController::class, 'options']);
    ...
    Route::middleware('throttle:api-write')->group(function () {
        ...
        Route::post('/buy-requests/quote', [BuyRequestController::class, 'quote']);
