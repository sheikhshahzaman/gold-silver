    ...
    public function run(): void
    {
        $pages = [
            [
                'title' => 'About Us',
                'slug' => 'about-us',
                'body' => '<h2>About Islamabad Bullion Exchange</h2>
<p>Islamabad Bullion Exchange is Pakistan\'s premier platform for real-time gold and silver price tracking. We provide accurate, up-to-the-minute pricing information for precious metals in the Pakistani market.</p>
<p>Our mission is to empower buyers, sellers, and investors with transparent and reliable gold and silver rate information. Whether you are looking to buy gold jewelry, invest in precious metals, or simply stay informed about market trends, Islamabad Bullion Exchange is your trusted source.</p>
<h3>What We Offer</h3>
<ul>
...
<p>We source our data from multiple reliable sources to ensure accuracy and timeliness of the information we provide.</p>',
                'meta_title' => 'About Us - Islamabad Bullion Exchange',
                'meta_description' => 'Learn about Islamabad Bullion Exchange, Pakistan\'s trusted source for real-time gold and silver prices.',
                'is_published' => true,
            ],
            [
                'title' => 'Disclaimer',
...
<p>The information provided on Islamabad Bullion Exchange is for general informational purposes only. While we strive to keep the information up to date and accurate, we make no representations or warranties of any kind, express or implied, about the completeness, accuracy, reliability, suitability, or availability with respect to the website or the information, products, services, or related graphics contained on the website for any purpose.</p>
...
<p>The content on this website does not constitute financial, investment, or trading advice. We recommend consulting with a qualified financial advisor before making any investment decisions related to precious metals.</p>',
                'meta_title' => 'Disclaimer - Islamabad Bullion Exchange',
                'meta_description' => 'Read the disclaimer for Islamabad Bullion Exchange. Understand the terms of use for our gold and silver price information.',
                'is_published' => true,
            ],
            [
...
<p>At Islamabad Bullion Exchange, we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website.</p>
...
<p>If you have any questions about this Privacy Policy, please contact us through our contact page.</p>',
                'meta_title' => 'Privacy Policy - Islamabad Bullion Exchange',
                'meta_description' => 'Read the privacy policy for Islamabad Bullion Exchange. Learn how we collect, use, and protect your personal information.',
                'is_published' => true,
            ],
            [
...
<p>Welcome to Islamabad Bullion Exchange. By accessing and using this website, you accept and agree to be bound by the terms and provisions of this agreement.</p>
...
<p>Unless otherwise stated, Islamabad Bullion Exchange owns the intellectual property rights for all material on this website. All intellectual property rights are reserved. You may access content from Islamabad Bullion Exchange for your own personal use subject to restrictions set in these terms and conditions.</p>
...
<p>In no event shall Islamabad Bullion Exchange, nor any of its officers, directors, and employees, be held liable for anything arising out of or in any way connected with your use of this website. Islamabad Bullion Exchange shall not be held liable for any indirect, consequential, or special liability arising out of or in any way related to your use of this website.</p>
<h3>Changes to Terms</h3>
<p>Islamabad Bullion Exchange reserves the right to revise these terms and conditions at any time. By using this website, you are expected to review these terms on a regular basis.</p>
<h3>Governing Law</h3>
<p>These terms and conditions are governed by and construed in accordance with the laws of Pakistan, and you irrevocably submit to the exclusive jurisdiction of the courts in that location.</p>',
                'meta_title' => 'Terms & Conditions - Islamabad Bullion Exchange',
                'meta_description' => 'Read the terms and conditions for using Islamabad Bullion Exchange website.',
                'is_published' => true,
            ],
        ];
